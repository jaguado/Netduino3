...
namespace Toolbox.NETMF.NET
{
    ...
    public class HTTP_Client
    {
        ...
        public HTTP_Client(SimpleSocket Socket)
        {
            ...
            // User Agent
            this.UserAgent = "Netduino/0.1 JAMSoluciones.cl; " + SocketProvider[SocketProvider.Length - 1] + "; " + Client[Client.Length - 1] + ")";
            // No referrer yet
            this.Referrer = "";
        }
        ...
        public HTTP_Response Get(string Url, string Arguments = "")
        {
            ...
            if (this._Username != "")
                RequestData += "Authorization: Basic " + JAM.Netduino3.Helpers.Utility.ToBase64String(System.Text.Encoding.UTF8.GetBytes(this._Username + ":" + this._Password)) + "\r\n";
